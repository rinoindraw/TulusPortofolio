...
export const Experience = () => {
  ...
  return (
<section className="my-experience" id="organization">
      <Container>
        ...
        <TrackVisibility>
          ...
          {experiences.map((experience, index) => (
            <React.Fragment key={index}>
              <Col xs={12} sm={12} md={7} className="d-flex align-items-center justify-content-center">
            ...
            {({ isVisible }) => (
              ...
              <Col xs={12} sm={12} md={3} className="d-flex align-items-center justify-content-center">
